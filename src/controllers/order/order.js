  ...
  try {
    ...
    const newOrder = new Order({
      ...
      deliveryLocation: {
        ...
        address: customerData.address || "No addrss available",
      },
      pickupLocation: {
        latitude: branchData.location.latitude,
        longitude: branchData.location.longitude,
        address: branchData.address || "No addrss available",
      },
    })
...
export const updateOrderStatus = async (req, reply) => {
  try {
    ...
    if (["cacncelled", "delivered"].includes(order.status)) {
...
export const getOrders = async (req, reply) => {
  try {
    ...
    //later come back and check for it for status
